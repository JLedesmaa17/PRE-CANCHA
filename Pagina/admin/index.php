    ...
    <header>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <?php if ($isLoggedIn): ?>
                    <?php if (isAdmin()): ?>
                        <li><a href="admin/index.php" class="btn-header">📊 Panel Admin</a></li>
                    <?php else: ?>
        ...
        <div class="canchas-grid">
            <?php foreach ($canchas as $cancha): ?>
                <div class="cancha-card">
                    ...
                    <?php if ($isLoggedIn): ?>
                        <a href="reservas.php?cancha=<?= $cancha['id'] ?>" class="btn-reservar" style="text-decoration: none;">
                            📅 Reservar Turno
                        </a>
                    <?php else: ?>
                        <a href="registro.php" class="btn-reservar" style="text-decoration: none;">
